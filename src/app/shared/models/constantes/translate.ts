// Este Map é gerado a partir do seu arquivo .properties
// Pode ser importado e usado em seus componentes ou serviços TypeScript.

export const ptBRTranslationMap = new Map<string, string>([
  ['phone', 'Contato'],
  ['cancel', 'Cancelar'],
