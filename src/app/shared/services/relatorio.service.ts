...
export class RelatorioService {
  ...
  public imprimirRelatorioInstancia(filter: any): Observable<any> {
    return this.http.post<any>(`${environment.urlApi}/relatorios/relatorios/instance`, filter, { responseType: 'blob' as 'json' });
  }
